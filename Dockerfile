FROM solr:7
RUN rm -rf /opt/solr/contrib/prometheus-exporter && \
    rm /opt/solr/server/lib/ext/log4j-core-2.11.0.jar /opt/solr/server/lib/ext/log4j-api-2.11.0.jar /opt/solr/server/lib/ext/log4j-slf4j-impl-2.11.0.jar && \
